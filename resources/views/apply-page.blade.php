        ...
        <div class="apply">
            ...
            <form action="" method="POST">
                ...
                <div class="row my-2">
                    ...
                    <div class="col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input" id="" aria-describedby="" placeholder="Enter Name">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            <label for="mobile no" class="text-secondary">Mobile Number</label>
                            <input type="text" class="form-control input" id="" aria-describedby="" placeholder="Enter Mobile">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input" id="" aria-describedby="" placeholder="Enter Email">
                        </div>
                    </div>
                </div>
                <hr class="hr-1">
                ...
                <div class="row my-2">
                    <div class="col-md-5 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control input" id="" aria-describedby="" placeholder="Enter Number Sets">
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-12 col-12">
                    ...
                    <div class="col-md-5 col-sm-12 col-12">
                        <div class="form-group">
                            <label for="email" class="text-secondary">Shipping Type
                            </label>
                            <input type="text" class="form-control input" id="" aria-describedby="" placeholder="Enter Shipping Type">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12 col-12">
                        <div class="form-group">
                            <label for="email" class="text-secondary">Delivery Address 1
                            </label>
                            <textarea name="" id="" class="input-text"></textarea>
                        </div>
                    </div>
                </div>
                <div class="text-center my-5">
                    <a href="#" class="btn btn-p btn-c width-2" role="button">PROCEED TO PAYMENT
                    </a>
                </div>
