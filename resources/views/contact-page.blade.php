                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control input" id="" aria-describedby="" placeholder="Enter Email">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input" id="" aria-describedby="" placeholder="Enter Subject">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea name="message" id="" class="input-text"></textarea>
                        </div>
                    </div>
                </div>
