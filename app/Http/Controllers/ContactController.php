...
class ContactController extends Controller
{
    ...
    {
      $contact = new Contact();
      $contact->Coname=$request->input('Coname');
      $contact->Comobile=$request->input('Comobile');
      $contact->Coemail=$request->input('Coemail');
      $contact->Cosubject=$request->input('Cosubject');
      $contact->Comessage=$request->input('Comessage');
